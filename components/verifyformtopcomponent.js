...
export default function verfytopcomponent({words,chain}){
return(
<div className="flex overflow-hidden flex-col mx-auto">

            <div className="flex flex-col w-[320px]   md:w-[675px] rounded-md  mx-auto md:mx-[0px] px-[13px] py-[21px] md:px-[37px] md:py-[19px]  md:h-[95px] h-[95px] flex-shrink-0 border-solid border-[1px] border-gray-700 bg-[#060606]" >
            <a href={`/verify/${words[1]}/?p=${words[2]}&chain=${chain}`} target="_blank" className="flex flex-row items-center">
                        ...
                        <div className="font-extralight md:text-[14px] text-[12px]  text-[#BEBEBE] md:my-[11px] my-[8px]  flex items-center">
                            {(words[0] === "1x") ?
                                <p>
                                    <CgProfile className="mr-2 inline" />{words[3]}
