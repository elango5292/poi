        ...
        <div className="flex overflow-hidden md:mb-9 mt-[40px] flex-col mx-auto">
            ...
            <div className="flex flex-col  mx-auto md:mx-[0px] px-[13px] py-[21px] md:px-[37px] md:py-[32px] w-[300px] md:w-[522px] md:h-[242px] h-[290px] flex-shrink-0 border-solid border-[1px] border-gray-700 bg-[#060606]" >
                <div className="flex flex-col md:flex-row">
                    ...
                    <Link className="text-[12px] mt-[31px] flex justify-center items-center  md:text-[14px] rounded-md md:mx-auto  md:my-auto  bg-[#D9D9D9] text-black w-[263px] md:w-[132px] h-[30px] md:h-[41px]  hover:cursor-pointer" onClick={handleverify} href="#enteryourdetails">
                        Verify Authorship
