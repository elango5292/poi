...
function Heropc(){
  ...
  return (
    <div className="w-screen top-0 left-0 resize-none relative overscroll-x-contain overflow-hidden h-screen"  ref={containerRef}>
      ...
      <div className="md:h-screen  h-full opacity-95 z-10 w-screen absolute mix-blend-difference hero" />
      ...
      <div className="rounded-full  overflow-hidden absolute animate-hero-light-1 top-[55%] left-[10%] md:left-[58%] z-[30] md:top-[50%] w-[25%] h-[25%] bg-white blur-2xl" />
      <div className="rounded-full absolute  overflow-hidden animate-hero-light-2 top-[45%] left-[20%] md:left-[58%] z-[30] md:top-[50%] w-[30%] h-[30%] bg-white blur-3xl" />
