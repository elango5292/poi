...
console.log(path);
  return (
    <Disclosure as="nav" className="border-0 backdrop-blur-md z-10 fixed w-full top-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10">
      {({ open }) => (
        <>
